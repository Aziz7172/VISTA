...
SECRET_KEY = 'django-insecure-mm-j)wu4w%#6v%*a6!1f6_(qjm5n39#ku7_9bh$q=x3+hg)g!9'
...
DEFAULT_FROM_EMAIL = 'your_email@example.com'  # Sender email
CONTACT_EMAIL = 'info@vistaacademy.com'        # Recipient email
